    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Report Add</h3>
            </div>
            <?php echo form_open('report/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="workman_id" class="form-control">
								...
								{
									$selected = ($workman['id'] == $this->input->post('workman_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="type_of_work" value="<?php echo $this->input->post('type_of_work'); ?>" class="form-control" id="type_of_work" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="work_hours" class="control-label">Work Hours</label>
						<div class="form-group">
							<input type="text" name="work_hours" value="<?php echo $this->input->post('work_hours'); ?>" class="form-control" id="work_hours" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="sendtime" class="control-label">Sendtime</label>
						<div class="form-group">
							<input type="text" name="sendtime" value="<?php echo $this->input->post('sendtime'); ?>" class="has-datetimepicker form-control" id="sendtime" />
						</div>
					</div>
				</div>
			</div>
